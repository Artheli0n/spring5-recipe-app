...
public class Recipe {
    ...
    // use this annotation for large objects (it creates a BLOB as this is a String) to have higher storage space allocated
    // (
    @Lob
    private Byte[] image;
    ...
    public void setIngredient(final Set<Ingredient> ingredient) {
